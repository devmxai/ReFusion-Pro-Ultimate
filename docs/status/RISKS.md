...
| RISK-010 | P0 | The experimental flat Layer/Timeline model can turn every drawing primitive into a track and force destructive schema/UI/Agent migrations | Decide RFC-0002 before G2 schema adoption; prove a bounded LayerGroup, distinct Track/Clip/Layer/ContentNode concepts and save/reopen identity before visual breadth | G2 |
| RISK-011 | P1 | The current nanosecond experiment may accumulate rounding error at rational frame rates or subframe shutter samples | Qualify an exact checked rational/tick representation before finalizing G2 time serialization or admitting temporal Motion Blur; retain ADR-0009 as the sole clock-authority decision | G2/G4 |
