...
| [ADR-0012](adrs/ADR-0012-verified-machine-dependency-cache.md) | adr | proposed | Verified development machine dependency cache | build-and-supply-chain | G0-WP04B | `adrs/ADR-0012-verified-machine-dependency-cache.md` |
| [ADR-0013](adrs/ADR-0013-high-precision-sdr-presentation-carrier.md) | adr | proposed | High-precision SDR display presentation carrier | principal-cross-platform-architecture | XPF-WINDOWS-DESKTOP-V1 | `adrs/ADR-0013-high-precision-sdr-presentation-carrier.md` |
