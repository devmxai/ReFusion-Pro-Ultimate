...
|---|---:|---|---|---|---|
| macOS arm64 | Desktop v1 | Metal/CAMetalLayer | VideoToolbox/CoreVideo | CoreAudio | Core plus engine-owned Metal and same-device Ganesh/Graphite context green; presenter/media pending |
| Windows x64 | Desktop v1 | D3D12/DXGI | Media Foundation hardware MFT | WASAPI | Core CI, D3D12 service and Skia profile defined; Windows execution pending |
